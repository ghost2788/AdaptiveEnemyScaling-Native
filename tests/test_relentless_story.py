...
class RelentlessStoryTests(unittest.TestCase):
    ...
    def harden(self, enemy, owner="fight"):
        self.story.add("DB_AESN_HpTransaction", owner, enemy, 1, "HPCommitted",
                       10, 10, 100.0, 20, 10, 10, fire=False)
        self.story.add("DB_AESN_ComponentApplication", owner, enemy, 1, "FullyCommitted", fire=False)
